...
const categories = ['javascript', 'data-structure', 'ai', 'java', 'network', 'math', 'blog', 'minecraft', 'chinese', 'japanese', 'cpp', 'python', 'security', 'order', 'os', 'confessions', 'vision', 'shinonome'];
